...
class MNIST(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
        ...
        if download:
            ...
            self.create_pt_files(root='/Users/sarazatezalo/Documents/EPFL/semestral project/data/MNIST')
    ...
    def create_pt_files(self, root):
        """Creates train.pt and test.pt files in the processed folder (for manually downloaded data) if they do not exist yet."""
        if self._check_exists():
            return
        ...
        # Replace the read_image_file and read_label_file with actual reading functions
        training_set = (
